...
def list_awi_data(dataset_id):
    dataset_link = "https://doi.pangaea.de/10.1594/PANGAEA.{}?format=html#download".format(
        dataset_id)
    ...
    datafile_prefix = "https://download.pangaea.de/dataset/{}/files/".format(
        dataset_id)
    ...
    for pole, dataset_ids in datasets.items():
        ...
        for dataset_id in dataset_ids:
            ...
            for data_url in data_urls:
                ...
                wget_cmd = ["wget", "-c", "--content-on-error",
